...
MP4V2_EXPORT
uint32_t MP4GetTotalSampleSize (MP4FileHandle hFile);

MP4V2_EXPORT
bool MP4CutTrackSampleInfo(MP4FileHandle hFile, uint32_t cutoffLen);

MP4V2_EXPORT
bool MP4SetMoovMode(MP4FileHandle hFile);

MP4V2_EXPORT
bool MP4SetBackupMode(MP4FileHandle hFile, bool mode);

MP4V2_EXPORT
bool MP4GetBackupMode(MP4FileHandle hFile);
